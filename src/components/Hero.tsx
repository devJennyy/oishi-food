...
const Hero = () => {
  return (
    <div id="hero" className="w-full bg-[url('/images/hero-bg.svg')] object-cover">
      <div className="flex justify-between max-w-[1440px] w-full mx-auto px-6 pt-56">
      <div className="flex flex-col text-left gap-5">
        ...
        <div className="flex gap-4 text-lg mt-5">
          <div className="py-[10px] px-8 rounded-full bg-secondary text-white">
            <p>Order Now</p>
          </div>
          <div className="py-[10px] px-8 rounded-full border border-secondary dark:border-white text-secondary dark:text-white">
            <p>Learn More</p>
          </div>
        </div>
      </div>
