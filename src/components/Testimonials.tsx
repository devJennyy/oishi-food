...
const Testimonials = () => {
  return (
    <div
      id="testimonials"
      className="flex items-center gap-12 xl:gap-32 lg:gap-16 h-[601px] max-w-[1440px] w-full mx-auto px-6 md:px-14 sm:px-16 lg:px-0 lg:pr-10 2xl:pr-[7.5rem] xl:pr-[4rem] mt-20 md:mt-0"
    >
      ...
      <div className="flex flex-col w-full h-full items-center lg:items-start gap-2">
        ...
        <p className="sm:font-bold font-black xl:max-w-[400px] lg:max-w-[350px] text-4xl sm:text-5xl md:text-4xl lg:text-[2rem] xl:text-[2.5rem] sm:leading-tight">
          What Our Clients<span className="text-secondary"> Say</span>
        </p>

        <div className="flex items-center gap-8 mt-8 lg:mt-5 xl:mt-8">
          <button className="hidden lg:hidden md:flex justify-center items-center w-[2.8rem] h-[2.8rem] bg-secondary/40 dark:bg-midnightBlue/40 rounded-full">
          ...
          <button className="hidden lg:hidden md:flex justify-center items-center w-[2.8rem] h-[2.8rem] bg-secondary/90 dark:bg-midnightBlue rounded-full">
